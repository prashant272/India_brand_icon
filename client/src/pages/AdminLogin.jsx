  ...
  return (
    <>
      <PageHero
        ...
        icon="🛡️"
        title={<span>Admin <span className="text-gradient-amber">Login</span></span>}
        subtitle="India Brand Icon Award & Conference, 2026 — Administrative Control Center."
      >
        <section className="min-h-[80vh] w-full relative flex items-center justify-center p-4 sm:p-6 pb-32">
          <div className="relative w-full max-w-[440px] flex flex-col items-center">
            <div className="w-full glass-card border border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.8)] group overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 via-transparent to-[#d4af37]/5 pointer-events-none" />
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2 group">
                  <label className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-amber-400/60 group-focus-within:text-amber-400 transition-colors ml-1">
                    <FiMail /> Administrator ID
                  </label>
                  <input
                    type="email"
                    className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-6 py-4 text-white text-base placeholder:text-white/10 focus:outline-none focus:border-amber-500/40 focus:bg-white/[0.06] transition-all"
                    value={email}
                ...
                >
                  <div
                    ...
                    style={{ background: `linear-gradient(135deg, #d97706, #3b82f6, #d4af37)` }}
                  />
              ...
              <div className="mt-12 pt-8 border-t border-white/5 text-center">
                <p className="text-amber-200/20 text-[10px] font-black uppercase tracking-widest">
                  Need access?{" "}
                  <Link
                    to="/admin/register"

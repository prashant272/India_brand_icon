...
const mediaSections = [
  {
    ...
    activeClasses: "text-white bg-amber-600/20 border border-amber-400 shadow-[0_0_20px_rgba(5,150,105,0.3)]",
    items: [
      { label: "Times of India Feature", date: "Jan 2024", desc: "Exclusive feature on India Brand Icon Award & Conference, 2026 ceremony and its impact on the international medical community.", media: { type: "image", src: "/images/print-placeholder-1.jpg" } },
      { label: "Hindustan Exclusive Coverage", date: "Feb 2023", desc: "Full-page coverage of award winners, keynote speeches, and india brand icon milestones celebrated at the event.", media: { type: "image", src: "/images/print-placeholder-2.jpg" } },
    ],
  },
  {
    icon: "📺",
    ...
    items: [
      { label: "", date: "March 2024", desc: "Special broadcast interview with key india brand icon leaders and award organisers discussing the future of india brand icon.", media: { type: "youtube", videoId: "FO9KwVu_GyA" } },
      { label: " ", date: "2023", desc: "National broadcast of the award ceremony, highlighting winners and their contributions to india brand icon excellence.", media: { type: "youtube", videoId: "LuCukRXeE_s" } },
    ],
  },
  {
    icon: "🌐",
    ...
    items: [
      { label: "Digital Media coverage", date: "May 2024", desc: "In-depth digital report covering the awards, jury insights, and the journey of india brand icon innovation in 2024.", media: { type: "image", src: "../digitalmedia.png" } },
      { label: "#InternationalIndia Brand IconAwards Trending", date: "2024", desc: "Award ceremony trended internationally on social media with thousands of posts celebrating india brand icon excellence.", media: { type: "image", src: "/images/banner-placeholder-2.jpg" } },
    ],
  },
];
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-16">
            ...
            {mediaSections.map((section) => (
              <button
                ...
                className={`relative px-6 sm:px-10 py-2 sm:py-3 rounded-full font-bold text-sm sm:text-lg transition-all duration-300 overflow-hidden group ${activeTab === section.title
                  ...
                  : 'text-slate-400 border border-slate-700 hover:text-white hover:border-amber-500 bg-amber-950/50'
                  }`}
              >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1">
                      {section.items.map((item, ii) => (
                        ...
                        >
                          ...
                          <p className="text-xs text-amber-100/60 text-left leading-relaxed mb-4">
                            {item.desc}
                          </p>
          ...
          <FadeUp className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <span className="glass-card border border-amber-400/20 px-6 py-3 text-sm text-amber-200/70 flex items-center gap-2 animate-border-glow">

    ...
    if (devToken) {
        return (
            <PageHero
                badge="Development"
                icon="🛠️"
                title={<span>Developer <span className="text-gradient-amber">Panel</span></span>}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-12">
                        <div className="lg:col-span-3 flex flex-col md:flex-row justify-between items-center bg-[#020817]/60 p-10 rounded-[2.5rem] border border-white/10  shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-4">
                                    <span className="w-2.5 h-2.5 rounded-full bg-amber-500 animate-pulse shadow-[0_0_15px_rgba(16,185,129,0.6)]" />
                                    <span className="text-[10px] font-black uppercase tracking-[0.5em] text-amber-400/80">Protocol: Secure_Bypass</span>
                                </div>
                                <h1 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter mb-3 leading-none">
                                    Prime <span className="text-gradient-amber">Developer</span> Console
                                </h1>
                                <p className="text-amber-100/30 text-[10px] font-black uppercase tracking-[0.3em]">Authorized Access — Node 9982</p>
                            </div>
                            <button
                        ...
                        <div className="bg-white/[0.03] border border-white/10 p-10 rounded-[2.5rem] flex flex-col justify-center relative overflow-hidden ">
                            ...
                            <div className="flex items-center gap-5">
                                <div className="w-16 h-16 rounded-[1.25rem] bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 shadow-lg">
                                    <div className="w-3 h-3 rounded-full bg-amber-400 animate-ping" />
                                </div>
                                <div>
                                    <p className="text-xl font-black text-white tracking-tighter">DEV_ROOT</p>
                                    <p className="text-[10px] font-black text-amber-400/60 uppercase tracking-widest">Sys_Admin_001</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    return (
        <>
            <PageHero
                ...
                icon="🔒"
                title={<span>Developer <span className="text-gradient-amber">Auth</span></span>}
            ...
            >
                <div className="flex items-center justify-center p-4 sm:p-6 pb-32">
                    <div className="w-full glass-card max-w-md border border-white/10 p-12 rounded-[3.5rem] shadow-[0_0_100px_rgba(16,185,129,0.1)] relative z-10  group overflow-hidden">
                        ...
                        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-amber-500 to-transparent animate-scan z-20" />

                        <div className="absolute inset-0 bg-gradient-to-br from-amber-500/[0.03] via-transparent to-purple-500/[0.03] pointer-events-none" />

                        <div className="flex justify-center mb-10 text-amber-400 relative">
                            <div className="absolute inset-0 bg-amber-500/20 blur-3xl rounded-full scale-150" />
                            <div className="w-24 h-24 rounded-[2rem] bg-amber-500/10 flex items-center justify-center border border-amber-500/20 shadow-2xl shadow-amber-500/20 relative z-10 group-hover:scale-110 transition-transform duration-500">
                        ...
                        <div className="text-center mb-12 relative z-10">
                            <h2 className="text-3xl font-black text-white uppercase tracking-tighter">
                                Security <span className="text-gradient-amber">Protocol</span>
                            </h2>
                            <p className="text-[10px] font-black text-amber-100/30 uppercase tracking-[0.6em] mt-3">Node Authentication Required</p>
                        </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            <div>
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 px-5 py-4 rounded-xl text-white placeholder:text-white/20 focus:outline-none focus:border-amber-500/50 transition-all text-center tracking-[0.2em] font-black text-sm"
                                />
                            </div>
                            <button
                                type="submit"

...
const STATUS_COLORS = {
    nominated: "text-amber-400 border-amber-400/30 bg-amber-400/10",
    evaluation: "text-yellow-400 border-yellow-400/30 bg-yellow-400/10",
    selected: "text-amber-400 border-amber-400/30 bg-amber-400/10",
...
export default function NominationDetails() {
    ...
    if (loading) {
        return (
            <div className="min-h-screen flex items-center justify-center text-amber-400 text-xl animate-pulse">
                Loading details...
            </div>
        );
    }
        ...
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
                <div className="bg-red-500/10 border border-red-500/50 p-8 rounded-3xl max-w-md">
                    ...
                    <button onClick={() => navigate("/dashboard")} className="flex items-center gap-2 text-amber-400 font-bold uppercase tracking-widest text-xs hover:underline">
        ...
        <>
            ...
            >
                <div className="relative z-10 max-w-4xl mx-auto pb-32">
                    ...
                    {/* Details Card */}
                    <div className="text-left bg-gradient-to-br from-slate-900/95 to-[#020817] backdrop-blur-2xl rounded-3xl border border-white/10 p-6 sm:p-10 shadow-2xl relative overflow-hidden shadow-black/60 ring-1 ring-white/5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10">
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-lg font-semibold text-white uppercase tracking-tight">{nomination.category}</p>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-base font-medium text-white/90">{nomination.participationType}</p>
                                    </div>

                                    <div className="space-y-2">
                                        <h3 className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Registration Type</h3>
                                        <p className="text-base font-medium text-white/90">{nomination.registrationType}</p>
                                    </div>
                                    ...
                                    {nomination.preferredLocation && (
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-base font-medium text-[#d4af37]">{nomination.preferredLocation}</p>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-base font-medium text-white/90">{nomination.email}</p>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-base font-medium text-white/90">{nomination.mobile}</p>
                                    </div>
                                    ...
                                    {nomination.participationType === "nominated as award" && (
                                        <div className="space-y-2">
                                            ...
                                            <div className="text-base font-medium text-white/80 space-y-1">
                    ...
                    <div className="mt-12 text-center">
                        <p className="text-xs font-bold text-gray-600 uppercase tracking-[0.3em]">
                            India Brand Icon Award & Conference, 2026 &bull; TIME Cyber Media Pvt Ltd
                        </p>
                    </div>
                </div>
            </PageHero>

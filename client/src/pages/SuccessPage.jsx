            ...
            >
                ...
                <div className="min-h-screen pt-32 pb-32 px-4 sm:px-6 flex items-center justify-center">
                    ...
                    <div className="max-w-xl w-full">
                        <ScaleIn delay={0.1}>
                            <NeonCard color="amber" className="p-8 md:p-12 text-center">
                                <div className="flex justify-center mb-8">
                                    <div className="relative">
                                        <div className="absolute inset-0 bg-amber-500/40 blur-3xl rounded-full animate-pulse" />
                                        <FiCheckCircle className="relative text-amber-400 w-24 h-24" />
                                    </div>
                                </div>

                                <h2 className="text-3xl md:text-5xl font-black text-white mb-4 tracking-tighter">
                                    Submission <span className="text-gradient-amber">Successful!</span>
                                </h2>

                                <p className="text-amber-100/60 text-base mb-10 leading-relaxed font-bold italic">
                                    Your nomination has been successfully received. Our team of experts will review your profile and connect with you shortly.
                                </p>

                                {autoCreated && (
                                    <FadeUp delay={0.3}>
                                        <div className="bg-amber-500/10 rounded-3xl p-6 mb-10 border border-amber-500/20 text-left ">
                                            ...
                                            <p className="text-amber-100/50 text-xs leading-relaxed font-bold">
                                                An account has been created for <strong className="text-amber-400">{email}</strong>.
                                ...
                                <div className="bg-white/5 rounded-3xl p-8 mb-10 border border-white/5 ">
                                    <h2 className="text-white font-black uppercase tracking-widest text-xs mb-6 flex items-center justify-center gap-2">
                                        <FiPhoneCall className="text-amber-400" /> Need Immediate Assistance?
                                    </h2>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="pt-2">
                                                <Link to="/contact" className="text-[10px] font-black text-amber-400 uppercase tracking-[0.2em] hover:text-amber-300 transition-colors">

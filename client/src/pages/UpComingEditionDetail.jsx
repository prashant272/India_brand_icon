                ...
                <div className="lg:col-span-8 space-y-8">
                    <div className="bg-slate-900 border border-white/10 rounded-[2rem] p-8 md:p-12 shadow-2xl">
                        ...
                        <div className="space-y-6 text-slate-300 text-lg leading-relaxed">
                            ...
                            <p>
                                {edition.hero || `Over the years, the India Brand Icon Awards have become a benchmark for recognizing quality, leadership, and innovation in the business sector. This ${displayYear} edition continues this legacy by honoring those who have made a significant impact on industry and entrepreneurship.`}
                            </p>

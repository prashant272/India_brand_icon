  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="By submitting a nomination for the India Brand Icon Award & Conference, 2026, the nominee and/or nominator agrees to the following terms and conditions."
      >
        {/* Terms Grid */}
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
              ...
              <StaggerItem key={i}>
                ...
                >
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      <h2 className="text-base font-black text-white leading-snug group-hover:text-amber-100 transition-colors">
                        {term.title}
                      </h2>
                  ...
                  <ul className="space-y-2 flex-1">
                    {term.items.map((item, j) => (
                      <li key={j} className="flex items-start gap-2.5">
                        ...
                        <span className="text-amber-100/70 text-sm text-left leading-relaxed group-hover:text-amber-100/85 transition-colors">
                          {item}
                        </span>
                      </li>
                    ))}
          ...
          {/* Acceptance note */}
          <FadeUp delay={0.4} className="mt-12 glass-card border border-amber-400/20 p-6 md:p-8 text-center animate-border-glow">
            <span className="text-2xl block mb-3">⚖️</span>
            <p className="text-amber-100/70 text-sm md:text-base leading-relaxed max-w-2xl mx-auto italic">
              By participating in the India Brand Icon Award & Conference, 2026, you acknowledge that you have read, understood, and agree to all the above Terms & Conditions.
            </p>
          </FadeUp>
        </div>
      </PageHero>

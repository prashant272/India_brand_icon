    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
                  ...
                  <ul className="space-y-3 flex-1">
                    {g.items.map((item, j) => (
                      <li key={j} className="flex items-start gap-3">
                        ...
                        <span className="text-amber-100/75 text-sm leading-relaxed group-hover:text-amber-100/90 transition-colors">
                          {item}
                        </span>
                      </li>
                    ))}
        ...
        <FadeUp delay={0.4} className="mt-12">
          <div className="glass-card border border-amber-400/20 p-6 md:p-8 text-center animate-border-glow">
            <span className="text-2xl mb-3 block">⚖️</span>
            <p className="text-amber-100/75 text-sm md:text-base leading-relaxed italic max-w-2xl mx-auto">

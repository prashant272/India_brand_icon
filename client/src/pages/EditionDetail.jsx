                ...
                {!edition && isCovidYear ? (
                    <div className="relative w-full py-20 px-6 sm:px-12 mb-12 sm:mb-16 rounded-[2rem] sm:rounded-[3rem] overflow-hidden bg-indigo-950/40 border border-white/10 flex flex-col items-center justify-center text-center shadow-[0_20px_50px_rgba(0,0,0,0.5)] group">
                        ...
                        <p className="text-slate-400 text-base sm:text-lg max-w-2xl italic leading-relaxed">
                            "The safety of our industry heroes was our top priority during the pandemic. We returned stronger and more resolute in the following years."
                        </p>
                    </div>
                ) : (
                    <>
                ...
                <div className="space-y-16 sm:space-y-24 mt-16 sm:mt-24">
                            ...
                            <section className="lg:col-span-5 flex">
                                <div className="w-full bg-indigo-950/50 p-8 sm:p-12 rounded-[2rem] sm:rounded-[3rem] border border-white/10 relative overflow-hidden group hover:border-[#d4af37]/30 transition-all duration-500 shadow-2xl flex flex-col justify-center">
                                    ...
                                    <div className="text-base sm:text-lg text-slate-300 leading-relaxed space-y-6 relative z-10">
                                        <p>
                                            Organized by <strong className="text-white font-bold tracking-wide">TIME Cyber Media Pvt Ltd</strong>, the {displayYear} ceremony in <strong className="text-[#d4af37] whitespace-nowrap">{edition.locations?.join(", ") || edition.locations}</strong> served as a powerful platform for networking, recognition, and industry excellence.
                                        </p>
                                        <p>
                                            From emerging startups to multinational conglomerates, we identified leaders who prioritize innovation, ethical business practices, and technological advancement in their respective fields.
                                        </p>
                                    </div>
                                </div>
                            </section>
                    ...
                    <section className="bg-indigo-950/60 p-8 sm:p-14 md:p-16 rounded-[2rem] sm:rounded-[3rem] border border-white/10 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 relative z-10">
                            {[
                                { title: "Nomination", desc: "Open call for business leaders, visionaries, and institutions." },

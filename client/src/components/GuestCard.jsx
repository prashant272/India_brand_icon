...
export default function GuestCard({ member, index, isFeatured = false }) {
  ...
  const medicalBlue = "#f59e0b"; // Amber-500
    ...
    >
      ...
      <div
        className="
          ...
          hover:border-amber-500/40 hover:shadow-amber-500/10 hover:shadow-2xl
      ...
      >
        ...
        <div className="flex flex-col flex-grow items-center text-center px-2 sm:px-3">
          ...
          <p
            className="text-sm sm:text-base lg:text-base font-medium leading-relaxed italic px-2 drop-shadow mb-4 min-h-[48px] flex items-center justify-center text-amber-100/90"
            style={{

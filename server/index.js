...
app.use(cors({
  origin: [
    ...
    "https://international-india brand icon-award.vercel.app",
    "https://globalindia brand iconawards.com",
    "https://www.globalindia brand iconawards.com",
    "http://localhost:5173",
    "http://localhost:5174",
  ],
...
mongoose.connection.on("connected", () => {
  ...
  console.log("🟢 Database: ", config.MONGO_DB_NAME);
  console.log("🟢 Host: ", config.MONGO_URI);
});
